...
public class studentmain {
    static String ogrencisim="";
    static String ogrencisoy="";
    static String ogrenciokul="";
    static String ogrencicinsyt="";
    ...
    _student obj=new _student("musa","kemal","Kabatas","Erkek",14);
